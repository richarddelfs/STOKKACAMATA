...
public class Barang extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nama = findViewById(R.id.nama5);
        merk = findViewById(R.id.merk1);
        tipe = findViewById(R.id.tipe1);
...
//                imagePath = storage.child("Qrcode");
                storageReference.putBytes(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot)
                    {
                        storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                Toast.makeText(Barang.this, "Berhasil Upload", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                    ...
                    {
                        Toast.makeText(Barang.this, "Gagal Upload", Toast.LENGTH_SHORT).show();
                    }
                });
