...
public class ScanUser2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scan_user2);
...
/*
    ...
    private void setupCamera() {
        btn_start_again = findViewById(R.id.btn_againuser2);
        ...
        cameraView = findViewById(R.id.cameraViewuser2);
            ...
            detector.detectInImage(image)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(ScanUser2.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
