...
public class SearchUser2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextNamaToko.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent history = new Intent(SearchUser2.this, HalamanToko.class);
        ...
        btnLogout3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intToMain = new Intent(SearchUser2.this, Login.class);
            ...
            ref.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if(dataSnapshot.exists())
                    {
                        ...
                        AdapterClassBarang adapterClassBarang = new AdapterClassBarang();
                        adapterClassBarang.list = list;
                ...
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    Toast.makeText(SearchUser2.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        }
